...
import 'package:flutter_pokedex_ea/pages/detail_page.dart';
import 'package:flutter_pokedex_ea/widget/poke_img_and_ball.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              //expanded sığmasa bile uyguylamaya sığmasını sağlar
            ],
          ),
        ),
      ),
